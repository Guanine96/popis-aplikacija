    ...
    <div className="flex min-h-dvh w-full bg-zinc-950">
      <aside className="sticky top-0 hidden h-dvh w-60 shrink-0 flex-col border-r border-cyan-500/10 bg-zinc-950 md:flex">
        <div className="flex items-center gap-2.5 px-5 py-5">
          <span className="flex size-9 items-center justify-center rounded-lg bg-cyan-500/15 text-cyan-400 ring-1 ring-cyan-500/40 shadow-[0_0_15px_rgba(0,240,255,0.08)]">
            <Boxes className="size-5" />
          </span>
          <div className="flex flex-col leading-tight">
            <span className="text-sm font-semibold text-zinc-100">Popis Robe</span>
            <span className="text-[10px] uppercase tracking-[0.25em] text-cyan-500/70">
              SaaS inventar
            </span>
          </div>
        </div>
