...
export function NumericKeypad({
  ...
  const keyClass = cn(
    ...
    "font-mono font-semibold text-cyan-300 tabular-nums select-none",
    compact ? "h-11 text-xl" : "h-16 text-2xl",
    "transition-all active:scale-95 active:bg-cyan-500/20 active:border-cyan-500/50",
